...
class _EventRecord_0 {
  alignment() {
    return _descriptor_0.alignment().concat(_descriptor_0.alignment().concat(_descriptor_0.alignment().concat(_descriptor_2.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment())))));
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_0.toValue(value_0.maxSupply).concat(_descriptor_0.toValue(value_0.minted).concat(_descriptor_0.toValue(value_0.expiration).concat(_descriptor_2.toValue(value_0.organizer).concat(_descriptor_1.toValue(value_0.isActive).concat(_descriptor_1.toValue(value_0.isPublicMint))))));
  }
}
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      createEvent: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_2.toValue(eventId_0).concat(_descriptor_0.toValue(maxSupply_0).concat(_descriptor_0.toValue(expiration_0).concat(_descriptor_1.toValue(isPublicMint_0)))),
            alignment: _descriptor_2.alignment().concat(_descriptor_0.alignment().concat(_descriptor_0.alignment().concat(_descriptor_1.alignment())))
          },
          output: undefined,
          publicTranscript: [],
          privateTranscriptOutputs: []
                                      ...
                                      [
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(pk_0),
                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_5.toValue(issuer_0),
  ...
  _deactivateIssuer_0(context, partialProofData, issuerPk_0) {
    ...
    const existing_0 = _descriptor_5.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                 partialProofData,
                                                                                 [
                                                                                  { dup: { n: 0 } },
                                                                                  { idx: { cached: false,
                                      ...
                                      [
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(evId_0),
                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_3.toValue(ev_0),
  ...
  _deactivateEvent_0(context, partialProofData, eventId_0) {
    ...
    const ev_0 = _descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                                                                           partialProofData,
                                                                           [
                                                                            { dup: { n: 0 } },
                                                                            { idx: { cached: false,
                          ...
                          minted:
                            ((t1) => {
                              if (t1 > 18446744073709551615n) {
                                throw new __compactRuntime.CompactError('poap.compact line 222 char 33: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                              }
                              return t1;
                            })(ev_0.minted + 1n),
                          expiration: ev_0.expiration,
                                      ...
                                      [
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(eventId_0),
                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_3.toValue(updatedEv_0),
                                                                                              alignment: _descriptor_3.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } },
                                       { ins: { cached: true, n: 1 } }]);
  ...
  _mintTo_0(context, partialProofData, eventId_0, recipientPk_0) {
    ...
    const updatedEv_0 = { maxSupply: ev_0.maxSupply,
                          minted:
                            ((t1) => {
                              if (t1 > 18446744073709551615n) {
                                throw new __compactRuntime.CompactError('poap.compact line 329 char 33: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                              }
                              return t1;
                            })(ev_0.minted + 1n),
                          expiration: ev_0.expiration,
