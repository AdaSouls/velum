...
class _EventRecord_0 {
  alignment() {
    return _descriptor_2.alignment().concat(_descriptor_2.alignment().concat(_descriptor_2.alignment().concat(_descriptor_1.alignment().concat(_descriptor_0.alignment().concat(_descriptor_0.alignment().concat(_descriptor_3.alignment().concat(_descriptor_1.alignment())))))));
  }
  fromValue(value_0) {
    return {
      maxSupply: _descriptor_2.fromValue(value_0),
      minted: _descriptor_2.fromValue(value_0),
      expiration: _descriptor_2.fromValue(value_0),
  ...
  toValue(value_0) {
    return _descriptor_2.toValue(value_0.maxSupply).concat(_descriptor_2.toValue(value_0.minted).concat(_descriptor_2.toValue(value_0.expiration).concat(_descriptor_1.toValue(value_0.organizer).concat(_descriptor_0.toValue(value_0.isActive).concat(_descriptor_0.toValue(value_0.isPublicMint).concat(_descriptor_3.toValue(value_0.metadataURI).concat(_descriptor_1.toValue(value_0.privateMetadataCommit))))))));
  }
}
...
class _Maybe_0 {
  ...
  toValue(value_0) {
    return _descriptor_0.toValue(value_0.is_some).concat(_descriptor_2.toValue(value_0.value));
  }
}
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      createEvent: (...args_1) => {
        if (args_1.length !== 7) {
          throw new __compactRuntime.CompactError(`createEvent: expected 7 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(eventId_0).concat(_descriptor_2.toValue(maxSupply_0).concat(_descriptor_2.toValue(expiration_0).concat(_descriptor_0.toValue(isPublicMint_0).concat(_descriptor_3.toValue(metadataURI_0).concat(_descriptor_1.toValue(privateMetadataCommit_0)))))),
            alignment: _descriptor_1.alignment().concat(_descriptor_2.alignment().concat(_descriptor_2.alignment().concat(_descriptor_0.alignment().concat(_descriptor_3.alignment().concat(_descriptor_1.alignment())))))
          },
          output: undefined,
          publicTranscript: [],
          privateTranscriptOutputs: []
      ...
      mintTo: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(eventId_0).concat(_descriptor_1.toValue(recipientPk_0)),
                       ...
                       isSoulbound_0)
  {
    ...
    const ev_0 = _descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
                                                                           ...
                                                                           [
                                                                            ...
                                                                            { idx: { cached: false,
                                                                                     ...
                                                                                     path: [
                                                                                            { tag: 'value',
                                                                                              value: { value: _descriptor_1.toValue(eventId_0),
                                                                                                       alignment: _descriptor_1.alignment() } }] } },
                                                                            { popeq: { cached: false,
                                                                                       result: undefined } }]).value);
    ...
    const pk_0 = this._holder_pk_0(context, partialProofData, issuerId_0);
    ...
    const tokenId_0 = _descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                partialProofData,
                                                                                [
                                                                                 { dup: { n: 0 } },
                                                                                 { idx: { cached: false,
                                      ...
                                      [
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(tokenId_0),
                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(issuerId_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } },
                                       { ins: { cached: true, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                          ...
                          minted:
                            ((t1) => {
                              if (t1 > 18446744073709551615n) {
                                throw new __compactRuntime.CompactError('poap.compact line 256 char 33: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                              }
                              return t1;
                            })(ev_0.minted + 1n),
                          expiration: ev_0.expiration,
  ...
  _claimOrUpdate_0(context, partialProofData, eventId_0, isSoulbound_0) {
    ...
    if (maybeToken_0.is_some) {
      ...
      const key_0 = this._holder_token_key_0(this._holder_pk_0(context,
                                                               partialProofData,
                                                               issuerId_0),
                                             issuerId_0);
  ...
  _mintTo_0(context, partialProofData, eventId_0, recipientPk_0) {
    ...
    let t_0;
    __compactRuntime.assert(this._equal_6(ev_0.maxSupply, 0n)
                            ||
                            (t_0 = ev_0.minted, t_0 < ev_0.maxSupply),
                            'Event has reached maximum supply');
    const issuerId_0 = ev_0.organizer;
    ...
    const updatedEv_0 = { maxSupply: ev_0.maxSupply,
                          minted:
                            ((t1) => {
                              if (t1 > 18446744073709551615n) {
                                throw new __compactRuntime.CompactError('poap.compact line 365 char 33: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                              }
                              return t1;
                            })(ev_0.minted + 1n),
                          expiration: ev_0.expiration,
                                                                                                ...
                                                                                                path: [
                                                                                                       { tag: 'value',
                                                                                                         value: { value: _descriptor_13.toValue(1n),
                                                                                                                  alignment: _descriptor_13.alignment() } }] } },
                                                                                       { push: { storage: false,
                                                                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(tId_0),
                                                                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
                                                                                       'member',
                                                                                       { popeq: { cached: true,
                                                                                                  result: undefined } }]).value),
    ...
    const issuerId_0 = _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                 ...
                                                                                 [
                                                                                  ...
                                                                                  { idx: { cached: false,
                                                                                           ...
                                                                                           path: [
                                                                                                  { tag: 'value',
                                                                                                    value: { value: _descriptor_2.toValue(tId_0),
                                                                                                             alignment: _descriptor_2.alignment() } }] } },
                                                                                  { popeq: { cached: false,
                                                                                             result: undefined } }]).value);
