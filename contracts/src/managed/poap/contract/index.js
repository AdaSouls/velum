...
class _EventRecord_0 {
  alignment() {
    return _descriptor_0.alignment().concat(_descriptor_0.alignment().concat(_descriptor_0.alignment().concat(_descriptor_2.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_3.alignment()))))));
  }
  fromValue(value_0) {
    return {
      maxSupply: _descriptor_0.fromValue(value_0),
      minted: _descriptor_0.fromValue(value_0),
      expiration: _descriptor_0.fromValue(value_0),
      organizer: _descriptor_2.fromValue(value_0),
      isActive: _descriptor_1.fromValue(value_0),
      isPublicMint: _descriptor_1.fromValue(value_0),
      metadataURI: _descriptor_3.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_0.toValue(value_0.maxSupply).concat(_descriptor_0.toValue(value_0.minted).concat(_descriptor_0.toValue(value_0.expiration).concat(_descriptor_2.toValue(value_0.organizer).concat(_descriptor_1.toValue(value_0.isActive).concat(_descriptor_1.toValue(value_0.isPublicMint).concat(_descriptor_3.toValue(value_0.metadataURI)))))));
  }
}
...
class _IssuerRecord_0 {
  ...
  fromValue(value_0) {
    return {
      organizerPk: _descriptor_2.fromValue(value_0),
      isActive: _descriptor_1.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_2.toValue(value_0.organizerPk).concat(_descriptor_1.toValue(value_0.isActive));
  }
}

const _descriptor_6 = new _IssuerRecord_0();
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.get_my_token_for_issuer) !== 'function') {
    ...
    if (typeof(witnesses_0.store_attendance) !== 'function') {
    ...
    if (typeof(witnesses_0.has_attended) !== 'function') {
    ...
    this.circuits = {
      ...
      registerIssuer: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_2.toValue(issuerPk_0),
      ...
      createEvent: (...args_1) => {
        if (args_1.length !== 6) {
          throw new __compactRuntime.CompactError(`createEvent: expected 6 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        ...
        const partialProofData = {
          input: {
            value: _descriptor_2.toValue(eventId_0).concat(_descriptor_0.toValue(maxSupply_0).concat(_descriptor_0.toValue(expiration_0).concat(_descriptor_1.toValue(isPublicMint_0).concat(_descriptor_3.toValue(metadataURI_0))))),
            alignment: _descriptor_2.alignment().concat(_descriptor_0.alignment().concat(_descriptor_0.alignment().concat(_descriptor_1.alignment().concat(_descriptor_3.alignment()))))
          },
          output: undefined,
          publicTranscript: [],
          privateTranscriptOutputs: []
      ...
      deactivateEvent: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_2.toValue(eventId_0),
            alignment: _descriptor_2.alignment()
          },
          output: undefined,
          publicTranscript: [],
      ...
      claimOrUpdate: (...args_1) => {
        if (args_1.length !== 3) {
          throw new __compactRuntime.CompactError(`claimOrUpdate: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const eventId_0 = args_1[1];
        const isSoulbound_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('claimOrUpdate',
                                     'argument 1 (as invoked from Typescript)',
                                     'poap.compact line 280 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(eventId_0.buffer instanceof ArrayBuffer && eventId_0.BYTES_PER_ELEMENT === 1 && eventId_0.length === 32)) {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_2.toValue(eventId_0).concat(_descriptor_1.toValue(isSoulbound_0)),
        ...
        const result_0 = this._claimOrUpdate_0(context,
                                               partialProofData,
                                               eventId_0,
                                               isSoulbound_0);
        partialProofData.output = { value: [], alignment: [] };
      ...
      mintTo: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_2.toValue(eventId_0).concat(_descriptor_2.toValue(recipientPk_0)),
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('claimOrUpdate', new __compactRuntime.ContractOperation());
  ...
  _get_my_token_for_issuer_0(context, partialProofData, issuerId_0) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.get_my_token_for_issuer(witnessContext_0,
                                                                                  issuerId_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(typeof(result_0) === 'object' && typeof(result_0.is_some) === 'boolean' && typeof(result_0.value) === 'bigint' && result_0.value >= 0n && result_0.value <= 18446744073709551615n)) {
      __compactRuntime.typeError('get_my_token_for_issuer',
                                 'return value',
  ...
  {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.store_attendance(witnessContext_0,
                                                                           tokenId_0,
                                                                           issuerId_0,
                                                                           eventId_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(Array.isArray(result_0) && result_0.length === 0 )) {
      __compactRuntime.typeError('store_attendance',
                                 'return value',
  ...
  _has_attended_0(context, partialProofData, issuerId_0, eventId_0) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.has_attended(witnessContext_0,
                                                                       issuerId_0,
                                                                       eventId_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(typeof(result_0) === 'boolean')) {
      __compactRuntime.typeError('has_attended',
                                 'return value',
  ...
  _holder_token_key_0(holderPk_0, issuerId_0) {
    return this._persistentHash_0([new Uint8Array([97, 100, 97, 115, 111, 117, 108, 115, 58, 104, 111, 108, 100, 101, 114, 45, 105, 115, 115, 117, 101, 114, 58, 118, 49, 58, 0, 0, 0, 0, 0, 0]),
                                   this._persistentHash_0([holderPk_0,
                                                           issuerId_0])]);
  }
  ...
  _is_active_issuer_0(context, partialProofData, issuerId_0) {
                                                                             ...
                                                                             path: [
                                                                                    { tag: 'value',
                                                                                      value: { value: _descriptor_12.toValue(6n),
                                                                                               alignment: _descriptor_12.alignment() } }] } },
                                                                    { push: { storage: false,
                                                                              value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(issuerId_0),
                                                                                                                           alignment: _descriptor_2.alignment() }).encode() } },
                                                                    'member',
                                                                    { popeq: { cached: true,
                                                                               result: undefined } }]).value))
    {
      ...
      const issuer_0 = _descriptor_6.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                 partialProofData,
                                                                                 [
                                                                                  { dup: { n: 0 } },
                                                                                  { idx: { cached: false,
                                                                                  ...
                                                                                  { idx: { cached: false,
                                                                                           ...
                                                                                           path: [
                                                                                                  { tag: 'value',
                                                                                                    value: { value: _descriptor_2.toValue(issuerId_0),
                                                                                                             alignment: _descriptor_2.alignment() } }] } },
                                                                                  { popeq: { cached: false,
                                                                                             result: undefined } }]).value);
      return issuer_0.isActive
             &&
             this._equal_1(issuerId_0,
                           this._caller_pk_0(context, partialProofData));
    }
  }
                                      ...
                                      [
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(pk_0),
                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_6.toValue(issuer_0),
                                                                                                 ...
                                                                                                 path: [
                                                                                                        { tag: 'value',
                                                                                                          value: { value: _descriptor_12.toValue(5n),
                                                                                                                   alignment: _descriptor_12.alignment() } }] } },
                                                                                        { push: { storage: false,
                                                                                                  value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(evId_0),
                                                                                                                                               alignment: _descriptor_2.alignment() }).encode() } },
                                                                                        'member',
                                                                                        { popeq: { cached: true,
                                                                                                   result: undefined } }]).value),
                                      ...
                                      [
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(evId_0),
                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_4.toValue(ev_0),
  ...
  _deactivateEvent_0(context, partialProofData, eventId_0) {
    ...
    const ev_0 = _descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
                                                                           partialProofData,
                                                                           [
                                                                            { dup: { n: 0 } },
                                                                            { idx: { cached: false,
                                                                            ...
                                                                            { idx: { cached: false,
                                                                                     ...
                                                                                     path: [
                                                                                            { tag: 'value',
                                                                                              value: { value: _descriptor_2.toValue(evId_0),
                                                                                                       alignment: _descriptor_2.alignment() } }] } },
                                                                            { popeq: { cached: false,
                                                                                       result: undefined } }]).value);
    __compactRuntime.assert(this._is_admin_0(context, partialProofData)
                       ...
                       isSoulbound_0)
  {
                                                                                                ...
                                                                                                path: [
                                                                                                       { tag: 'value',
                                                                                                         value: { value: _descriptor_12.toValue(5n),
                                                                                                                  alignment: _descriptor_12.alignment() } }] } },
                                                                                       { push: { storage: false,
                                                                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(eventId_0),
                                                                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
                                                                                       'member',
                                                                                       { popeq: { cached: true,
                                                                                                  result: undefined } }]).value),
    ...
    const ev_0 = _descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
                                                                           ...
                                                                           [
                                                                            ...
                                                                            { idx: { cached: false,
                                                                                     ...
                                                                                     path: [
                                                                                            { tag: 'value',
                                                                                              value: { value: _descriptor_2.toValue(eventId_0),
                                                                                                       alignment: _descriptor_2.alignment() } }] } },
                                                                            { popeq: { cached: false,
                                                                                       result: undefined } }]).value);
    ...
    const pk_0 = this._caller_pk_0(context, partialProofData);
    const key_0 = this._holder_token_key_0(pk_0, issuerId_0);
    __compactRuntime.assert(!_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       partialProofData,
                                                                                       [
                                                                                        { dup: { n: 0 } },
                          ...
                          minted:
                            ((t1) => {
                              if (t1 > 18446744073709551615n) {
                                throw new __compactRuntime.CompactError('poap.compact line 230 char 33: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                              }
                              return t1;
                            })(ev_0.minted + 1n),
                          expiration: ev_0.expiration,
                                      ...
                                      [
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(eventId_0),
                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_4.toValue(updatedEv_0),
                                                                                              alignment: _descriptor_4.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } },
                                       { ins: { cached: true, n: 1 } }]);
  ...
  _updateToken_0(context, partialProofData, tokenId_0, issuerId_0, eventId_0) {
    __compactRuntime.assert(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
  ...
  _claimOrUpdate_0(context, partialProofData, eventId_0, isSoulbound_0) {
    __compactRuntime.assert(!_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       partialProofData,
                                                                                       [
                                                                                        { dup: { n: 0 } },
    ...
    const ev_0 = _descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
                                                                           ...
                                                                           [
                                                                            ...
                                                                            { popeq: { cached: false,
                                                                                       result: undefined } }]).value);
    const issuerId_0 = ev_0.organizer;
    const maybeToken_0 = this._get_my_token_for_issuer_0(context,
                                                         partialProofData,
                                                         issuerId_0);
    if (maybeToken_0.is_some) {
      this._updateToken_0(context,
                          partialProofData,
                          maybeToken_0.value,
                          issuerId_0,
      ...
      const key_0 = this._holder_token_key_0(this._caller_pk_0(context,
                                                               partialProofData),
                                             issuerId_0);
      if (_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                    partialProofData,
                                                                                ...
                                                                                result: undefined } }]).value))
      {
        ...
        this._mintTokenInternal_0(context,
                                  partialProofData,
                                  issuerId_0,
                                  evId_0,
                                  isSoulbound_0);
  ...
  _mintTo_0(context, partialProofData, eventId_0, recipientPk_0) {
    const evId_0 = eventId_0;
    ...
    __compactRuntime.assert(this._is_admin_0(context, partialProofData)
                            ||
                            this._equal_6(ev_0.organizer,
                                          this._caller_pk_0(context,
                                                            partialProofData)),
                            'Not authorized to mint for this event');
    let t_0;
    __compactRuntime.assert(this._equal_7(ev_0.maxSupply, 0n)
                            ||
                            (t_0 = ev_0.minted, t_0 < ev_0.maxSupply),
                            'Event has reached maximum supply');
    const issuerId_0 = ev_0.organizer;
    const key_0 = this._holder_token_key_0(recipient_0, issuerId_0);
    __compactRuntime.assert(!_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       partialProofData,
                                                                                       [
                                                                                        { dup: { n: 0 } },
    ...
    const updatedEv_0 = { maxSupply: ev_0.maxSupply,
                          minted:
                            ((t1) => {
                              if (t1 > 18446744073709551615n) {
                                throw new __compactRuntime.CompactError('poap.compact line 338 char 33: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                              }
                              return t1;
                            })(ev_0.minted + 1n),
                          expiration: ev_0.expiration,
